...
var _subA = new dialogue(-1, "Ou a flora se enrubesce ao se trocar com toda a estação? Esse mundo inteiro está em constante mudança. Do que importa que eu amava Hérmia ontem, se hoje amo a ti?",
			_next);
_optionA = new p_option("Por acaso a maré se envergonha de mudar com todo luar?", -3, _subA); 
_optionB = new p_option("Eu estava fora de mim quando jurei amor a Hérmia!", +2, _next); 
_optionC = new p_option("Perdão, fui moleque.", -6, _next);
